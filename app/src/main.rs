	...
	fn view(&self, _ctx: &Context<Self>) -> Html {
		...
		let x = html! {
			<a-scene>
				...
				<a-entity position="-2 0.5 -3" rotation="0 45 0" geometry="primitive: box" material="color: #4CC3D9"/>
				<a-sphere position="0 0.95 -6" radius="1" color="#EF2D5E"></a-sphere>
...
pub fn kanji_block(props: &KanjiBoxProps) -> Html {
	...
	let html = html! {
		<a-entity position={props.position} rotation={props.rotation}>
			...
			<a-entity position="0 0 0" geometry="primitive: box; width: 1.0; height: 1.0" material="color: #445566; opacity: 0.4; transparent: true"/>
		</a-entity>
	};
	html
}
